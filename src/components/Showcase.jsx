  ...
  useGSAP(() => {
    if (!isTablet) {
      ...
      const timeline = gsap.timeline({
        scrollTrigger: {
          trigger: "#showcase", //trigger the animation when showcase is reached
          start: "top top", //start when the top of the section is at the top of the screen
          end: "bottom top", //end when the bottom of the section is at the top of the screen,
          scrub: true,
          pin: true,
        },
      });
